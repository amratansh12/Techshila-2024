...
const DEFAULT_POSITION = [51.505, -0.09]; // Example: London's latitude and longitude
...
const LocationSelectorMap = ({ onLocationSelected }) => {
  ...
  return (
    <MapContainer center={position || DEFAULT_POSITION} zoom={13} style={{ height: '400px', width: '100%' }}>
      <TileLayer
